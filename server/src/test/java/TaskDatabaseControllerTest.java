...
public class TaskDatabaseControllerTest {
    ...
    private void setupTestingEnv() throws FileNotFoundException {
        ...
        this.cardController = new CardController(dummyCardRepository, dummyListRepository, listController);


        // setup app controller
        this.taskController = new TaskController(taskRepository, dummyCardRepository, cardController);
    ...
    private void addSetupTask(
        ...
        this.taskController.addTask(task, cardID);
    }
    ...
    public void correctlyFetchesTasksEmpty() {
        assertEquals(new ArrayList<>(), this.taskController.getAllTasks());
    }
    ...
    public void correctlyCreatesTask1() throws FileNotFoundException {
        ...
        task.card = this.cardController.getCardByID(1L);
    ...
    public void correctlyCreatesTask2() throws FileNotFoundException {
        ...
        task.card = this.cardController.getCardByID(2L);
    ...
    public void correctlyFetchesTasksPopulated() throws FileNotFoundException {
        ...
        task1.card = this.cardController.getCardByID(1L);

        Task task2 = new Task();
        task2.id = 2L;
        task2.text = "second task, with ID=2";
        task2.card = this.cardController.getCardByID(2L);

        List<Task> taskList = new ArrayList<>();
        taskList.add(task1);
        taskList.add(task2);

        assertEquals(taskList, this.taskController.getAllTasks());
    }
    ...
    public void correctlyFetchesTaskByID() throws FileNotFoundException {
        ...
        assertEquals(task2, this.taskController.getTasksByID(2L));
    }
    ...
    public void correctlyEditsTask() {
        ...
        Task original = this.taskController.getTasksByID(1);
        ...
        // get the update task
        this.taskController.editTask(created);
        Task taskExtracted = this.taskController.getTasksByID(1);
    ...
    public void correctlyDeletesTask() {
        ...
        // delete the task
        this.taskController.deleteTask(taskExtracted);
        taskExtracted = this.taskController.getTasksByID(1);
    ...
    public void correctlyGetsNumberAllTasks() {
        ...
        int beforeAddition = this.taskController.getNumberOfTasks(cardController.getCardByID(1));
        ...
        int afterAddition = this.taskController.getNumberOfTasks(cardController.getCardByID(1));
    ...
    public void correctlyGetsNumberCompletedTasks() {
        ...
        int afterAddition = this.taskController.getNumberOfCompletedTasks(cardController.getCardByID(1));
    ...
    public void correctlyListsFindTaskByCardID() throws FileNotFoundException {
        ...
        model1.card = this.cardController.getCardByID(1L);

        Task model2 = new Task();
        model2.id=2;
        model2.text = "second task, with ID=2";
        model2.card = this.cardController.getCardByID(2L);

        // get all lists
        List<Task> tasksExtracted = this.taskController.getTasksByCardId(1L);
    ...
    public void correctlyIncrementsRankOnAdd() {
        ...
        Task taskOne = this.taskController.getTasksByID(1L);
        long rankTask1Before = taskOne.rank;

        addSetupTask(2L, "second task, with ID=2", 1L, false);

        taskOne = this.taskController.getTasksByID(1L);
    ...
    public void correctlyFetchesDifferentTasks() {
        ...
        modelList.add(this.taskController.getTasksByID(3L));
        modelList.add(this.taskController.getTasksByID(1L));
    ...
    public void correctlyMovesTasks() {
        ...
        Task moved = this.taskController.getTasksByID(2L);

        this.taskController.moveTaskAndRestructure(moved, 0L);
        // now should be:
        //      task ID         rank
        //      1               2
        //      2               0
        ...
        assertEquals(this.taskController.getTasksByID(1).rank, 2L);
        assertEquals(this.taskController.getTasksByID(2).rank, 0L);
        assertEquals(this.taskController.getTasksByID(3).rank, 1L);
    }
    ...
    public void correctlySquashesTasks() {
        ...
        this.taskController.deleteTask(this.taskController.getTasksByID(2L));
        this.taskController.squashTaskRanks(1L);
        ...
        assertEquals(this.taskController.getTasksByID(1).rank, 1L);
        assertEquals(this.taskController.getTasksByID(3).rank, 0L);
    }
}
