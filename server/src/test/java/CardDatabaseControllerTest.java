...
public class CardDatabaseControllerTest {
     ...
     * @throws FileNotFoundException when files not found
     */
    private void addDefaultList(long boardID) throws FileNotFoundException {
        ...
        list2.id = 2;
        list2.name = "list2";
        this.listController.addList(list1, boardID);
        this.listController.addList(list2, boardID);
    }
    ...
    private void addFirstDefaultCard(long listID) throws FileNotFoundException {
        Card card = new Card();
        card.id = 1;
        card.list = this.listController.getListByID(listID);
    ...
    public void correctlyFetchesCardsEmpty() {
        assertEquals(new ArrayList<Card>(), this.cardController.getAllCards());
    }
    ...
    public void correctlyCreatesCard1() throws FileNotFoundException {
        ...
        card.id = 1L;
        card.name = "first card";
        card.list = this.listController.getListByID(1L);
        card.rank = 0L;
    ...
    public void correctlyCreatesCard2() throws FileNotFoundException {
        ...
        card.id = 2L;
        card.name = "second card";
        card.list = this.listController.getListByID(2L);
        card.rank = 0L;
    ...
    public void correctlyFetchesCardsPopulated() throws FileNotFoundException {
        ...
        card1.list = this.listController.getListByID(1L);
        card1.rank = 0L;

        Card card2 = new Card();
        card2.id = 2L;
        card2.name = "second card";
        card2.list = this.listController.getListByID(2L);
        card2.rank = 0L;
        ...
        assertEquals(cardList, this.cardController.getAllCards());
    }
    ...
    public void correctlyFetchesCardByID() throws FileNotFoundException {
        ...
        assertEquals(card, this.cardController.getCardByID(2));
    }
    ...
    public void correctlyUpdateRankMultiCards() throws FileNotFoundException {
        ...
        card2.id = 2L;
        card2.name = "second card";
        card2.list = this.listController.getListByID(1L);
        card2.rank = 1L;
    ...
    public void correctlyEditsCards() throws FileNotFoundException {
        ...
        expected.list = this.listController.getListByID(1L);
        expected.rank = 0;

        // get the update list
        this.cardController.saveCardOverwrite(expected);
        Card newCard = this.cardController.getCardByID(1);
    ...
    public void correctlyDeletesCard() throws FileNotFoundException {
        ...
        assertNotNull(this.cardController.getCardByID(1L));

        // delete the card
        this.cardController.deleteCard(this.cardController.getCardByID(1L));
        Card deletedCard = this.cardController.getCardByID(1L);
    ...
    public void correctlyFetchesCardsByListId() throws FileNotFoundException {
        ...
        assertEquals(cardsInList1, this.cardController.getCardsByListId(1L));
    }
}
