...
public class ListControllerTest {
    ...
    public void setUp() throws FileNotFoundException {
        ...
        this.controller = new AppController(dummyBoardRepository, dummyListRepository,
                null, null, null, null, randomPassword);
        addSetupBoard(
                1,
                "first board"
        );
    ...
    public void correctlyListsAllListsAdded() throws FileNotFoundException {
        ...
        // get all lists
        List<ListEntity> listsExtracted = this.controller.getAllLists();
    ...
    public void correctlyListsFindListByID() throws FileNotFoundException {
        ...
        // get the list
        ListEntity listExtracted = this.controller.getListByID(2);
    ...
    public void correctlyListsFindListByBoardID() throws FileNotFoundException {
        ...
        // get all lists
        List<ListEntity> listsExtracted = this.controller.getListsByBoardId(1L);
    ...
    public void correctlyEditsListByID() throws FileNotFoundException {
        ...
        // call edit lists
        this.controller.editList(edited);

        // get list from repo
        ListEntity listExtracted = this.controller.getListByID(1);
    ...
    public void correctlyDeletesListByID() throws FileNotFoundException {
        ...
        assertNotNull(this.controller.getListByID(1));

        // delete the list
        ListEntity listRemoved = this.dummyListRepository.getById(1L);
        this.controller.removeList(listRemoved);
        ListEntity listExtracted = this.controller.getListByID(1);
